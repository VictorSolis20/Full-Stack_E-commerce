...
export class DescuentoService {
  ...
  listar_descuentos_admin(
    ...
    return this._http.get(
      this.url + 'listar_descuentos_admin/' + filtro,
      {
        headers: headers,
      }
    );
  ...
  eliminar_descuento_admin(
    ...
    return this._http.delete(
      this.url + 'eliminar_descuento_admin/' + id,
      {
        headers: headers,
      }
    );
  ...
  registro_descuento_admin(
    ...
    return this._http.post(
      this.url + 'registro_descuento_admin', fd,
      {
        headers: headers,
      }
    );
  ...
  obtener_descuento_admin(
    ...
    return this._http.get(
      this.url + 'obtener_descuento_admin/' + id,
      {
        headers: headers,
      }
    );
  ...
  actualizar_descuento_admin(
    ...
    if(data.banner){
      ...
      return this._http.put(
        this.url + 'actualizar_descuento_admin/'+id, fd,
        {
          headers: headers,
        }
      );
      ...
      return this._http.put(
        this.url + 'actualizar_descuento_admin/' + id, data,
        {
          headers: headers,
        }
      );
